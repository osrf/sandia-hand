...
#
# hacked up mercilessly by Morgan Quigley, November 2013
#
...
def main():
   ...
   grasp_pub = rospy.Publisher('simple_grasp', SimpleGrasp)
         ...
         for event in data:
            ...
            if (control[0] & 0xF0) == 176:
               ...
               if control_id == 43:
                 ...
                 amount = float(control[2]) / 127.0


               if grasp is not None:
                 grasp_pub.publish(SimpleGrasp(grasp, amount))
               else:
                 print "please select a grasp"
               ...
               #print "%d : %d" % (control_id, control[2])
